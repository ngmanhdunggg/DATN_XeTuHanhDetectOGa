...
class PotholeProcessor(QObject):
    ...
    def save_pothole_record(self, track_id, image_crop, area_cm2, depth_cm, lat, lon, timestamp_str):
        ...
        # 2. Tạo đường dẫn đến thư mục ngày (C:\...\OGa\2026-05-06)
        day_dir = os.path.join(self.images_dir, today_str)
        
        # 3. Tạo thư mục nếu chưa tồn tại
        if not os.path.exists(day_dir):
            os.makedirs(day_dir, exist_ok=True)
        
        # 4. Tạo đường dẫn đầy đủ của file ảnh
        # filepath sẽ là: C:\Users\dung2\Desktop\GiaoDienOGa\OGa\2026-05-06\pothole_track5...jpg
    ...
    def process_frame(self, cv_img, metadata):
        ...
        for track in active_tracks:
            ...
            # Xử lý ROI2: nếu center nằm trong ROI2 thì cập nhật max depth và đánh dấu đã vào ROI2
            ...
            # Nếu track đã từng vào ROI2, hiện tại không còn trong ROI2, và chưa được lưu -> lưu
            if track.has_entered_roi2 and not currently_in_roi2 and not track.saved and track.has_captured:
                ...
                if crop is not None:
                    ...
                    record_id = self.save_pothole_record(track.id, crop, area_cm2, max_depth, lat, lon, ts_str)
